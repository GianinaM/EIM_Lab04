...
public class ContactsManagerActivity extends AppCompatActivity {
    ...
    public ContactsManagerActivity() {
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addressEditText = (EditText)findViewById(R.id.addres_edit);
        jobTitleEditText =(EditText)findViewById(R.id.job_edit);
        companyEditText =(EditText)findViewById(R.id.company_edit);
        websiteEditText = (EditText)findViewById(R.id.website_edit);
        imEditText = (EditText)findViewById(R.id.im_edit);
